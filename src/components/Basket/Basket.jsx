...
import {sendingMessage} from "../../NodeMailer/mailer";

const Basket = ({items,totalPrice,totalCount,ClearAllAction,removeItemAction,plusItemAction,minusItemAction}) => {
            ...
            {totalCount ?<div className="container container--cart">
                <div className="cart">
                    ...
                    <div className="content__items">
                        {
                            pizzas.map(item => <ItemBasket key = {item.id}
                                                           {...item}
                    ...
                    <div className="cart__bottom">
                        ...
                        <div className="cart__bottom-buttons">
                            ...
                            <div className="button pay-btn" onClick={()=> sendOrder()}>
